...
namespace EmptyTest
{
    ...
    {
        public Dictionary<T1, T2> dict1 = new Dictionary<T1, T2>();
        public Dictionary<T2, T1> dict2 = new Dictionary<T2, T1>();
    ...
    {
        public DoubleDict<int, TValue> data = new DoubleDict<int, TValue>();
        int counter;
